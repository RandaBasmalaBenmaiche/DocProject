    ...
    return (
        ...
        >
            ...
            <Collapse in="open" timeout="auto" unmountOnExit
                ...
                <Link to={"/simple/mesQuize"} className='Links'>
                    <ListItem disablePadding>
                        <ListItemButton
                            sx={{
                                maxWidth: '95%',
                ...
                <Link to={"/simple/QuizeCM"} className='Links'>
                    <ListItem disablePadding>
                        <ListItemButton
                            sx={{
                                maxWidth: '95%',
            ...
            <Collapse in="open" timeout="auto" unmountOnExit
                ...
                <Link to={"/simple/statModules"} className='Links'>
