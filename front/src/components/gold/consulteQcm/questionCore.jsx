                        ...
                        type == "qcm" ?
                            ...
                            type == "qcs" ?
                                reponses.map((reponsess, indexx) => {
                                    return (<Qcs key={indexx} seconds={seconds} index={indexx} reponses={reponsess} idQestion={idQestion} histreponse={histreponse} corect={corect} appdate={appdate} chekArray={cheked} />)
                                })
                                :
                                type == "croc" ?
                                    reponses.map((reponse, index) => {
