...
const StatModulesG = () => {
    ...
    //fetch data
    const GetModuleStatBytime = (time) => {
        const config = {
            headers: {
                'authorization': `Bearer ${token.token}`
            }
        }
        axios.get(`${API_BASE}/stat/modules/time/` + time, config).then(res => {
            setModule(res.data)
            setLoadingModule(false)
            setErrorModule(false)
    ...
    const GetModulesStatByTimeAndAnnee = (time, year) => {
        const config = {
            headers: {
                'authorization': `Bearer ${token.token}`
            }
        }
        axios.get(`${API_BASE}/stat/modules/time/annee/` + time + "/" + year, config).then(res => {
            setModule(res.data)
            setLoadingModule(false)
            setErrorModule(false)
            setSuccessModule(true)
    ...
    const GetModulesStatByModuleAndTimeAndAnnee = (moduleFilter, time, year) => {
        const config = {
            headers: {
                'authorization': `Bearer ${token.token}`
            }
        }
        axios.get(`${API_BASE}/stat/modules/time/annee/` + moduleFilter + "/" + time + "/" + year, config).then(res => {
            setModule(res.data)
            setLoadingModule(false)
            setErrorModule(false)
            setSuccessModule(true)
    ...
    const GetModuleStatByModuleAndTime = (moduleFilter, time) => {
        const config = {
            headers: {
                'authorization': `Bearer ${token.token}`
            }
        }
        axios.get(`${API_BASE}/stat/modules/time/` + moduleFilter + "/" + time, config).then(res => {
            setModule(res.data)
            setLoadingModule(false)
            setErrorModule(false)
            setSuccessModule(true)
    ...
    React.useEffect(() => {
        if (moduleFilter === '' && year === '') {
            GetModuleStatBytime(checked)
        } else if (moduleFilter !== '' && year === '') {
            GetModuleStatByModuleAndTime(moduleFilter, checked)
        } else if (moduleFilter === '' && year !== '') {
            GetModulesStatByTimeAndAnnee(checked, year)
        } else {
            GetModulesStatByModuleAndTimeAndAnnee(moduleFilter, checked, year)
        }
