        ...
        <MenuList sx={{ width: '100%', borderRadius: 2, p: 1 / 2, mb: 2, mt: 1 }}>
            ...
            <Grid container xs={12} sx={{ display: 'flex', p: 2, borderRadius: 2, bgcolor: 'white',boxShadow:'3px 3px 6px rgba(0,0,0,0.2)' }}>
                <Grid item xs={12} sm={6}
                    ...
                    <ListItemText sx={{ fontFamily: 'Bahnschrift SemiBold',flex: '1 0 30%' }}>De </ListItemText>
                    <ListItemIcon sx={{ fontFamily: 'Bahnschrift SemiBold',flex: '1 0 70%' ,mr:1/2}}>
                ...
                <Grid item sm={6} xs={12}
                    ...
                    <ListItemText  sx={{fontFamily: 'Bahnschrift SemiBold', flex: '1 0 30%' }}>Jusqu'à</ListItemText>
